...
$lang = array(
	...
	'blockdata' => array('personalinfo' => '個人資料', 'profile' => '頭像', 'doing' => '記錄', 'feed' => '動態',
				'blog' => '日志', 'stickblog' => '置頂日志', 'album' => '相冊', 'friend' => '好友',
	...
	'doing_li' => '<li>{message}</li><br />{date} {from} 回複({replynum})',
	...
	'wall_reply' => '<a href="home.php?mod=spacecp&ac=comment&op=reply&cid={cid}&handlekey=replycommenthk_{cid}" id="c_{cid}_reply" onclick="showWindow(this.id, this.href, \'get\', 0);">回複</a>',
	...
	'poll_li' => '<div class="c z"><img alt="poll" src="static/image/feed/poll.gif" alt="poll" class="t" /><h4 class="h"><a target="_blank" href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a></h4><div class="mtn xg1">發布時間：{dateline}</div></div>',
	...
	'block_blog_no_content' => '現在還沒有日志',
	'block_blog_no_content_publish' => '，<a href ="home.php?mod=spacecp&ac=blog">發布日志</a>',
	...
	'block_thread_no_content_publish' => '，<a href ="forum.php?mod=misc&action=nav&special=0&from=home" onclick="showWindow(\'nav\', this.href);return false;">發布主題</a>',
	...
	'viewthread_userinfo_regtime' => '注冊時間',

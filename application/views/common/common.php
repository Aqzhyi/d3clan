		...
		<div class="header" id="header">
			...
			<div class="commercial_ad g_clear" id="commercial_ad">
				...
				<?php echo $this->media->embed_flash( array(
					'width'  => '270',
					'height' => '60',
					'src'    => '/static/file/common/ad/banner_HD710_270x60_tw.swf',
					'class'  => 'single',
				) ) ?>
				<a target="_blank" class='single' href="http://www.intel.com.tw/content/www/tw/zh/processors/core/core-i7-processor.html"><img src="/static/file/common/ad/image001.jpg" alt="" /></a>
